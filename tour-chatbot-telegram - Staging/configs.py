...
tf.app.flags.DEFINE_float('learning_rate', 1e-5, 'learning rate')  # 학습률
tf.app.flags.DEFINE_integer('shuffle_seek', 1000, 'shuffle random seek')  # 셔플 시드값
tf.app.flags.DEFINE_integer('max_sequence_length', 5, 'max sequence length')  # 시퀀스 길이
...
tf.app.flags.DEFINE_string('data_path', './data_in/question_data.csv', 'data path')  # 데이터 위치
